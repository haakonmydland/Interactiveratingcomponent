...
export default function Card({ title, paragraph, btnTxt }: CardInterface) {
  ...
  return (
    <div className="container">
      <div className={style.card}>
        ...
        <p className={style.paragraph}>{paragraph ? paragraph : "paragraph"}</p>
      ...
      <div className={style.centeredCard}>
        <img
          ...
          alt="Star Icon"
        />
        <div className={style.choice}>You selected 4 out of 5</div>
        <h1 className={style.centeredTitle}>{title ? title : "title"}</h1>
